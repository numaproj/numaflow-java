...
public class ServerNackTest {
    ...
    public void setUp() throws Exception {
        ...
        GRPCConfig grpcServerConfig = GRPCConfig.newBuilder()
                ...
                .build();
        server = new Server(grpcServerConfig, new NackTransformer(), null, serverName);
        server.start();
    ...
    private static class NackTransformer extends SourceTransformer {
        @Override
        public MessageList processMessage(String[] keys, Datum datum) {
            return MessageList.newBuilder()
                    .addMessage(Message.toNack(TEST_EVENT_TIME,
