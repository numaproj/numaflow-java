...
public class ServerFailTest {
    ...
    public void setUp() throws Exception {
        ...
        GRPCConfig grpcServerConfig = GRPCConfig.newBuilder()
                ...
                .build();
        server = new Server(grpcServerConfig, new FailBatchMapFn(), null, serverName);
        server.start();
    ...
    private static class FailBatchMapFn extends BatchMapper {
        @Override
        public BatchResponses processMessage(DatumIterator datumStream) {
            ...
            while (true) {
                ...
                batchResponse.append(Message.toFail());
