...
public class ServiceFailTest {
    ...
    public void setUp() throws Exception {
        ...
        service = new Service(new FailMapStreamer(), shutdownSignal);
    ...
    private static class FailMapStreamer extends MapStreamer {
        @Override
        public void processMessage(String[] keys, Datum datum, OutputObserver outputObserver) {
            outputObserver.send(Message.toFail());
        }
    }
}
